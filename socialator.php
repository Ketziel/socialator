...
/* ==========================================================================
   ...
   ========================================================================== */
    ...
    $cacheTime = $modx->getOption('cacheTime', $scriptProperties, 1800);
    $cacheId = $modx->getOption('cacheId', $scriptProperties, 'socialator');
    ...
    $cacheOptions = array(
        xPDO::OPT_CACHE_KEY => 'socialator'
    );

    $output = $modx->cacheManager->get('socialator', $options);
    ...
    /* ==========================================================================
       ...
       ========================================================================== */
        ...
        $modx->cacheManager->set('socialator', $output, $cacheTime, $options);
    }
